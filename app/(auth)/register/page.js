  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        // Assume the API logs them in and sets the cookie
    ...
    <div className="min-h-screen w-full flex bg-[#f8fafc] text-[#0f172a] selection:bg-[#164e63] selection:text-white">
      ...
      <div className="w-full lg:w-1/2 lg:ml-[50%] flex items-center justify-center p-6 sm:p-12 min-h-screen py-12">
        <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-xl border border-slate-100 relative my-auto">
          ...
          <h2 className="text-3xl font-black text-[#0f172a] mb-2">Create Your Doctor Account</h2>
          <p className="text-slate-500 font-medium mb-8">Start your 14-day free trial. No credit card required.</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#164e63] focus:border-transparent outline-none transition-all font-medium text-slate-900"
